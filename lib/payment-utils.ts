...
export const PAYMENT_METHOD_NAMES: Record<string, string> = {
  ...
  "PAID_AZAMPAY": "AzamPay MoMo",
  "AZAMPAY": "AzamPay MoMo", 
...
export function formatPaymentMethod(method: string | null | undefined): string {
  ...
  if (normalized.startsWith("AZAMPAY") || normalized.includes("AZAMPAY")) {
    return "AzamPay MoMo"
  }
...
export function isAutoGeneratedPaymentRef(value?: string | null): boolean {
  ...
  return (
    ...
    s.startsWith("URUBUTO-PENDING") ||
    s.startsWith("AZAMPAY-PENDING")
  )
}
...
export function resolveOrderPaymentStatus(
  ...
  if (name.includes("URUBUTO") || name.includes("AZAMPAY")) {
...
export function formatSupplierOrdersTablePayment(
  ...
  if (normalized.includes("AZAMPAY")) {
    return isPaid ? "Paid (AzamPay)" : "Awaiting AzamPay"
  }
  if (isPaid) {
...
export function formatSupplierOrderPaymentDisplay(
  ...
  if (normalized.includes("AZAMPAY")) {
    return {
      status: isPaid ? "paid" : "pending",
      displayName: isPaid ? "Paid via AzamPay" : "Awaiting AzamPay",
      methodLabel,
      isPaid,
    }
  }
