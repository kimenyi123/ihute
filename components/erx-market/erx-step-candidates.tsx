 ...
 * ALL pharmacies serving the items, closest first, ALL preselected.
 * Sort chips: Hafi / ★ Amanota / Stock ukuri / Sync. Copy verbatim from
 * ihute_erx_sample_v4.html.
 */
        ...
        <div className="flex gap-1.5 my-2.5" role="tablist" aria-label="Sort pharmacies">
          {ERX_COPY.sortChips.map(([key, label]) => (
            <button
              ...
              onClick={() => setSort(key as ErxCandidateSort)}
              className={cn(
