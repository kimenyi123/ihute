...
import { CreditCard, Smartphone, Wallet, Building2, Banknote } from "lucide-react"
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">We Accept Multiple Payment Methods</h2>
          <p className="text-slate-600 text-sm">Choose the payment option that works best for you</p>
        </div>
