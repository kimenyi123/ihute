...
import { getProductUploadsDir } from "@/lib/image-upload-paths"
...
/** Serve uploaded product images from disk (beta-safe when cwd/public differs from localhost). */
export async function GET(
  ...
  const baseDir = getProductUploadsDir()
