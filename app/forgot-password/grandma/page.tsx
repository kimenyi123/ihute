...
/** Grandma / shop.ihute.rw: phone + street verification, then new password inline. */
export default function GrandmaForgotPasswordPage() {
  const router = useRouter()
  const loginHref = GRANDMA_PATHS.login
    ...
    <div className="min-h-screen bg-[#eef4fb] text-[#17324d]">
      <div className="mx-auto max-w-[430px] min-h-screen bg-gradient-to-b from-[#f7fbff] to-[#eef4fb] pb-28">
        ...
        <div className="space-y-4 px-3 pt-4">
          <Link href={loginHref} className="inline-flex items-center gap-2 text-sm font-medium text-[#1897e0] hover:underline">
            ...
            <CardContent>
              {done ? (
                <div className="space-y-4 text-center">
                  ...
                  <Button className={btnPrimary} onClick={() => router.push(loginHref)}>
                    Go to sign in
                  </Button>
                </div>
              ) : (
